...
const Report = () => {
  ...
  useEffect(() => {
    const filtered = transactions.filter((val) => val.date.startsWith(selectedMonth));
  ...
  return (
    <div className='flex flex-col items-center justify-center h-full'>
      ...
      <div className='flex flex-col justify-center items-center'>
        <label htmlFor="" className='text-sm font-bold'>Select Month</label>

        <div className='flex flex-row justify-between items-center w-[700px] border-2 outline-2 rounded p-1 m-1 cursor-pointer'>
          <input
            ref={inputRef}
            type="month"
            value={selectedMonth}
